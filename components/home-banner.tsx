  ...
  return (
    <>
      <section className="home-banner flex justify-center items-start h-screen">
        <div className="container lg:pt-20 lg:ml-40 mt-20 lg:mt-0 items-center flex flex-col">
          ...
          <p className="text-center text-lg text-gray-500 font-medium leading:4 lg:leading-8 lg:w-96 mt-6 mb-8">
            Get valuable feedback from more patients and experience the positive
            effects it has on your online reputation.
          </p>
          <Button className="py-2 lg:py-4 ml-0" text="Request demo" />
        </div>
      </section>
      <style jsx>
        {`
