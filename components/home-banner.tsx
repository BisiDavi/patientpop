  ...
  return (
    <>
      <section className="home-banner flex justify-center items-start h-screen">
        <div className="container lg:pt-20 lg:ml-40 mt-16 lg:mt-0 items-center lg:items-start flex flex-col">
          ...
          <p className="text-center px-4 lg:px-0 lg:text-left text-sm lg:text-lg text-gray-500 font-medium leading:4 lg:leading-8 lg:w-96 mt-6 lg:mb-8 mb-4">
            Get valuable feedback from more patients and experience the positive
            effects it has on your online reputation.
          </p>
          <Button
            className="py-2 px-4 lg:py-4 lg:px-6 lg:py-4 ml-0 lg:w-52"
            text="Request demo"
          />
        </div>
      </section>
